...
More information at issue #36`
        ...
        const rules = ('rules' in config.module) ? config.module.rules : config.module.loaders;
        if (config.module[rules].some((l) => l.test.test(filePath) || l.test.test(fileAbsPath))) {
